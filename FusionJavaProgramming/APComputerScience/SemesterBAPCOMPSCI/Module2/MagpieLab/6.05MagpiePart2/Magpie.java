...
public class Magpie
{
  ...
  public String getResponse(String statement)
  {
    ...
    // handle "I want <something>" statement
    else if (findKeyword(statement, "I want to", 0) >= 0)
    {
   ...
   *
   * @param statement the user's statement, assumed to contain "I want to"
   ...
   *
   * @param statement the user's statement, assumed to contain "I want"
   * @return the transformed statement
   */
   ...
   *
   * @param statement the user's statement, assumed to contain "you" followed by "me"
   * @return the transformed statement
   */
  ...
  /**
   * Takes a statement with "I <something> you" and transform it into
   * "Why do you <something> me?"
   *
   * @param statement the user's statement, assumed to contain "I" followed by "you"
   * @return the transformed statement
   */
